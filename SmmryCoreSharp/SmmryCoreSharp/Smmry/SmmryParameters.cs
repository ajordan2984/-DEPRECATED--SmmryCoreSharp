...
namespace SmmryCoreSharp.Smmry
{
    public class SmmryParameters : Dictionary<string, object>
    {
        ...
        /// <summary>
        /// The publicly accessible URL to fetch content from. Either "Url" or "Text" must be part of your request but not both.
        /// </summary>
        ...
        /// <summary>
        /// The text to summarize. Either "Url" or "Text" must be part of your request but not both.
        /// This parameter is hidden on the list of API parameters available at https://smmry.com/api.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return ContainsKey("sm_api_input") ? url : string.Concat(url, $"&SM_URL={Url}");
        }
    }
}